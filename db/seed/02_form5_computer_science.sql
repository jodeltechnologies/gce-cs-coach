...
SELECT id, title, status, content FROM lessons
 WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND deleted_at IS NULL
...
SELECT category_of_action, exam_frequency, continues_from_id, link_confirmed
  FROM competencies WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND exam_frequency IS NOT NULL;
...
UPDATE syllabi SET
  ...
  updated_at = now()
WHERE id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b';
...
UPDATE lessons SET deleted_at = now(), status = 'archived',
  sequence = sequence + 1000 + (SELECT coalesce(max(sequence), 0)
                                  FROM lessons WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b')
 WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND deleted_at IS NULL
   AND id NOT IN (SELECT id FROM new_lesson_ids);

UPDATE competencies SET deleted_at = now(),
  sequence = sequence + 1000 + (SELECT coalesce(max(sequence), 0)
                                  FROM competencies WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b')
 WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND deleted_at IS NULL
   AND id NOT IN (SELECT id FROM new_comp_ids);

UPDATE modules SET deleted_at = now(),
  sequence = sequence + 1000 + (SELECT coalesce(max(sequence), 0)
                                  FROM modules WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b')
 WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND deleted_at IS NULL
...
INSERT INTO modules (id, syllabus_id, title, sequence) VALUES ('1dfa7753-f563-557f-97a6-69478902daef', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'Network Systems 2', 1)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO modules (id, syllabus_id, title, sequence) VALUES ('df4137a6-5a80-5b98-b667-dda47cb185c5', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'Hardware and Software Systems 3', 2)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO modules (id, syllabus_id, title, sequence) VALUES ('7c69c79f-0cbe-584c-ab87-e6217114e10d', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'Problem Solving and Coding 3', 3)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO modules (id, syllabus_id, title, sequence) VALUES ('b57c82c5-7aa3-5794-aaff-0eabce484433', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'Data Manipulation', 4)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO modules (id, syllabus_id, title, sequence) VALUES ('be83a247-8136-5bcb-8b44-00157af86214', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'System Security', 5)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO modules (id, syllabus_id, title, sequence) VALUES ('ae91ff23-61c6-54d4-8826-f50665eee233', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'Data Manipulation 2', 6)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO modules (id, syllabus_id, title, sequence) VALUES ('b8bc06cc-9f8a-5904-8f9f-5746140bef4b', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'Ethics, Society and Legal Issues 3', 7)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();

INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('4931bd0a-3baf-5034-b348-a28f169aa5a0', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef', 'Social networks', 'Given the need to share experiences and knowledge, learners communicate using platforms that permit interaction in real-time.', 1)
...
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('fbbd16cb-d90d-52d6-ac58-c7b5fd73a502', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5', 'Exploring Application Areas of Computers', 'Provided with a situation related to the use of AI, learners write appropriate prompts to get an output or response.', 2)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('7877b7e6-60a8-52a6-a876-a28c21748ed6', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d', 'Evaluating an information system', 'Given the description of an information system learners evaluate its effectiveness, efficiency, security, ease of use and reliability justifying their answer in each case.', 3)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('771b76e8-183b-5a74-8320-c5a2b6960269', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d', 'Developing a system', 'In a situation of developing a system for a school, business, party management, etc., learners select and design appropriate ways of organising data, describe the processing of data, and select appropriate hardware and software for the given task.', 4)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d', 'Designing and implementing simple databases', 'Provided with a problem in an organisation related to databases, learners build simple database systems for the organisations. The implementation should meet the needs of the organisation.', 5)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('38cb1f79-7f8e-51a8-9473-fbe7546fc3ce', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d', 'Managing projects', 'In a situation where a number of activities (tasks) are given', 6)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('96d82bf9-41b4-557f-ac93-ae14b98f0e36', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d', 'Describing data structure', 'After analysing a problem such that the variables in a problem are known, learners choose the appropriate data type for each variable and determine the best data structure to use to guarantee efficient processing.', 7)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('e0593f92-07c1-5452-bf03-52a71b21f72f', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d', 'Writing algorithms', 'Presented with a problem, learners express the solution by writing down instructions that will lead to solving the problem efficiently.', 8)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('5284706e-4919-517c-b499-e71aeb43de24', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d', 'Converting an algorithm into a program', 'In a situation where the algorithm for a problem is available, learners develop corresponding instructions in a programming language; using the appropriate IDE.', 9)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('6f7fbf19-ad41-5f93-a920-119992f27f28', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b57c82c5-7aa3-5794-aaff-0eabce484433', 'Representing data in the computer', 'In a situation where data is stored in the computer, learners identify and use coding schemes to represent data', 10)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('8315ac79-ae54-5a89-973a-082fe5028c9f', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5', 'Describing peripheral devices', 'In a situation where a computer is to be equipped for various purposes, learners identify appropriate input and output peripheral devices for high productivity.', 11)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('063973b1-6361-5576-ba1d-22d274b43c15', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5', 'Creating digital content using a software', 'Given tasks to accomplish, learners use appropriate features of a software to correctly accomplish the task.', 12)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('91928cc7-d9bb-57a0-a8bd-2a8c3974c75e', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5', 'Proposing assistive technology for social inclusion', 'Given a situation with factors related to the aging and users with disabilities, learners select appropriate technologies for a given disability while clearly justifying their choices.', 13)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('e057c48c-6e4d-500f-b789-31f326bf4fbe', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef', 'Exploring the concepts related to data communication', 'Given a situation with factors related to data communication systems, learners explain correctly, concisely, and precisely the mechanisms used in the situation.', 14)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('2318c65c-9a89-5d36-bbec-37a0073f80aa', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef', 'Setting up LANs', 'Given a situation that requires setting up a simple network, learners prescribe the appropriate tools and configuration to meet the needs of the situation.', 15)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('7d9101e7-22d4-5580-a0d0-fd5a67a96351', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214', 'Securing data, computers, and networks', 'Given a computing environment where computers, data and networks are exposed to security threats, learners identify potential risks and implement appropriate measures to protect data, computers and networks, justifying the security measures selected.', 16)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('0c7ff2e1-a9f3-54a4-befe-85e0fd3fafc1', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214', 'Evaluating the impacts of digital identities and digital footprints', 'Given a situation outlining the online practices of a user, learners evaluate their management of digital footprints, expose the risk they are facing and recommend tips for managing footprints and reputation.', 17)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('39f52bd2-576e-5d17-bd34-f710b0248ce5', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'ae91ff23-61c6-54d4-8826-f50665eee233', 'Analysing simple logic circuits and logic expressions', 'Presented with a logic circuit or expression, learners isolate the different components and correctly express the possible output', 18)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('6c84227d-049c-5332-b809-0b38b62530f3', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5', 'Describing internal components of the computer', 'Provided with a situation with factors related to devices that are not peripherals, learners select devices or features of these devices that are coherent to the situation and justify their choice.', 19)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('ff4f0be6-8728-52b1-b276-05d8ae6d7533', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef', 'Working on the Internet', 'Given a situation related to the use of the internet and its services, learners select appropriate service clearly justifying their choice', 20)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('2f2f678d-3028-5a88-b97a-4f0ec3d656d3', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5', 'Getting application software', 'Provided with tasks to produce or edit digital content, learners choose the most appropriate software for each task clearly justifying their choice.', 21)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('d234982c-0c81-5986-9cfb-061e8876a7e6', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5', 'Describing ways of acquiring and distributing software', 'Describe ways of acquiring or distributing software', 22)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
INSERT INTO competencies (id, syllabus_id, module_id, category_of_action, competency_statement, sequence) VALUES ('de3308d3-d130-5748-a357-767930a51948', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b8bc06cc-9f8a-5904-8f9f-5746140bef4b', 'Examine licenses and copyright practices', 'Placed in a situation with issues related to intellectual property, learners propose ways of identifying free and copyrighted data or digital content, ways of protecting digital content and ways of using content protected by a given license. Proposals should be coherent with the situation and clearly justified.', 23)
ON CONFLICT (id) DO UPDATE SET module_id = EXCLUDED.module_id, category_of_action = EXCLUDED.category_of_action, competency_statement = EXCLUDED.competency_statement, sequence = EXCLUDED.sequence, deleted_at = NULL, updated_at = now();
...
INSERT INTO lessons (
  ...
  '2e089d6f-34fb-5ced-9902-faee79254ae7', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  '4931bd0a-3baf-5034-b348-a28f169aa5a0',
...
INSERT INTO lessons (
  ...
  '7688e7a1-c1d1-511b-b86a-b6ebb4ba42bf', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  '4931bd0a-3baf-5034-b348-a28f169aa5a0',
...
INSERT INTO lessons (
  ...
  '2a62b118-1f2d-5230-aa0f-d8af6c2e1897', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  '4931bd0a-3baf-5034-b348-a28f169aa5a0',
...
INSERT INTO lessons (
  ...
  '73182402-17b8-5b66-80c0-d76c4aa72469', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  '4931bd0a-3baf-5034-b348-a28f169aa5a0',
...
INSERT INTO lessons (
  ...
  '5a593871-3a74-557f-86e9-8efd6b355119', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  'fbbd16cb-d90d-52d6-ac58-c7b5fd73a502',
...
INSERT INTO lessons (
  ...
  '879e6c1f-ff31-5aac-9da4-7823a1f1f447', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  'fbbd16cb-d90d-52d6-ac58-c7b5fd73a502',
...
INSERT INTO lessons (
  ...
  '42c5f076-ff33-5971-adfa-cb1acc6c2bb1', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  'fbbd16cb-d90d-52d6-ac58-c7b5fd73a502',
...
INSERT INTO lessons (
  ...
  'b776aa60-8b1c-53dd-a831-2e02c9bec88a', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  'fbbd16cb-d90d-52d6-ac58-c7b5fd73a502',
...
INSERT INTO lessons (
  ...
  'c9ca63f6-cff4-5d80-ae71-3f9b030d5b98', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  '28b795c2-db74-5152-b4cc-171306d86e17', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  '20e293d6-2159-523e-a0e2-38f3dbc31925', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  'c7dbd713-b85f-5fe6-9b5b-89afd115f89d', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  'cbc727dd-cf42-53eb-99cb-9a0fc37ceb1e', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  '87735a6c-be38-57e3-a5bf-5d0fd8d2b49b', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  '4fee4a98-3643-5420-9083-664fe4ef96af', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  '1ead9a9c-bd8e-5a8e-b272-e45956e03cd6', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  '55264793-24d0-5ee4-bfbe-914db5c05118', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '7877b7e6-60a8-52a6-a876-a28c21748ed6',
...
INSERT INTO lessons (
  ...
  '4993ab6e-378e-5c9f-9a6d-ced04f5bfa1e', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '771b76e8-183b-5a74-8320-c5a2b6960269',
...
INSERT INTO lessons (
  ...
  '60617863-4064-5401-b8d2-23aff5200f4d', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '771b76e8-183b-5a74-8320-c5a2b6960269',
...
INSERT INTO lessons (
  ...
  '84f541b4-c4e0-52d7-ad09-7260b25c9efb', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '771b76e8-183b-5a74-8320-c5a2b6960269',
...
INSERT INTO lessons (
  ...
  '40c00a04-65c8-580b-be69-8f92c8a8128d', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '771b76e8-183b-5a74-8320-c5a2b6960269',
...
INSERT INTO lessons (
  ...
  '85deeca0-1819-5f4b-9fd5-dde681a4046e', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46',
...
INSERT INTO lessons (
  ...
  'fe1b2fb9-4136-5d62-b06c-b78f9f1ccc78', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46',
...
INSERT INTO lessons (
  ...
  '8c164910-9cb1-5a80-a38f-83d979a99283', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46',
...
INSERT INTO lessons (
  ...
  '72002622-3768-5d6a-9cf0-504e0ddd951c', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46',
...
INSERT INTO lessons (
  ...
  '578f2a51-8fee-589e-89ec-015545284f87', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46',
...
INSERT INTO lessons (
  ...
  'e5cb7edc-fbdf-5278-9ed7-254168a8b9df', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46',
...
INSERT INTO lessons (
  ...
  '7941ce6a-d1da-5310-8122-179662fd86bb', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '4aa0df6c-1dd5-5207-b1f4-cafbb01e8b46',
...
INSERT INTO lessons (
  ...
  'd9ec8af7-2575-5811-9aac-c08b74066490', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '38cb1f79-7f8e-51a8-9473-fbe7546fc3ce',
...
INSERT INTO lessons (
  ...
  '460c3c54-b0c8-57ca-af9d-001e76b80701', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '38cb1f79-7f8e-51a8-9473-fbe7546fc3ce',
...
INSERT INTO lessons (
  ...
  'c63a80f4-99bb-51f6-9330-c247407d14ec', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '38cb1f79-7f8e-51a8-9473-fbe7546fc3ce',
...
INSERT INTO lessons (
  ...
  'f4eb3ca8-17f3-5ab6-9619-8aacb2bfdccb', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '38cb1f79-7f8e-51a8-9473-fbe7546fc3ce',
...
INSERT INTO lessons (
  ...
  '253eb78d-e614-5a10-991c-2803c3d74cac', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '38cb1f79-7f8e-51a8-9473-fbe7546fc3ce',
...
INSERT INTO lessons (
  ...
  'ea9fe6cb-86bb-58d8-bf38-10a4c69c8313', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '38cb1f79-7f8e-51a8-9473-fbe7546fc3ce',
  NULL, NULL, 'Evaluation',
  1, 11, 11,
  true, false, false,
...
INSERT INTO lessons (
  ...
  '907d780e-4afc-560e-b3f9-1b55c7f3df4f', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '38cb1f79-7f8e-51a8-9473-fbe7546fc3ce',
  NULL, NULL, 'Remediation',
  1, 12, 12,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'c5e6b0d3-914a-5e14-8110-bdd943e08360', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '96d82bf9-41b4-557f-ac93-ae14b98f0e36',
...
INSERT INTO lessons (
  ...
  'f71523d3-fb29-507b-b8d8-3a618e8017d4', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '96d82bf9-41b4-557f-ac93-ae14b98f0e36',
...
INSERT INTO lessons (
  ...
  '135bce20-bfc9-517e-a959-51a5a6d2534c', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '96d82bf9-41b4-557f-ac93-ae14b98f0e36',
...
INSERT INTO lessons (
  ...
  '8039934d-309f-5fa7-9d40-0c9233c3e363', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  'e0593f92-07c1-5452-bf03-52a71b21f72f',
...
INSERT INTO lessons (
  ...
  '7fdd8171-ce86-52ef-b99a-63ab33c0f8db', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  'e0593f92-07c1-5452-bf03-52a71b21f72f',
...
INSERT INTO lessons (
  ...
  'e326b97d-6152-595b-a39b-ed2baf93ab45', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  'e0593f92-07c1-5452-bf03-52a71b21f72f',
...
INSERT INTO lessons (
  ...
  'af1a7aaf-a4b0-573a-a88d-5c2204b52c7f', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  'e0593f92-07c1-5452-bf03-52a71b21f72f',
...
INSERT INTO lessons (
  ...
  '258ac047-a2a3-59fe-8388-35475369d85b', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  'e0593f92-07c1-5452-bf03-52a71b21f72f',
...
INSERT INTO lessons (
  ...
  'a199b4d6-6191-50e4-9021-256fedd057a9', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  'e0593f92-07c1-5452-bf03-52a71b21f72f',
...
INSERT INTO lessons (
  ...
  '31c5877e-d784-54c8-9dc2-e285d15bc8b8', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '5284706e-4919-517c-b499-e71aeb43de24',
...
INSERT INTO lessons (
  ...
  'ffcf8639-40a6-5faa-9eec-38e9ec713b38', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '5284706e-4919-517c-b499-e71aeb43de24',
...
INSERT INTO lessons (
  ...
  '3ab7f3d9-c2b8-53e5-98f1-1da03cf063fc', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '5284706e-4919-517c-b499-e71aeb43de24',
...
INSERT INTO lessons (
  ...
  '937c0718-dc2d-5872-be2f-f39b225ac07f', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '7c69c79f-0cbe-584c-ab87-e6217114e10d',
  '5284706e-4919-517c-b499-e71aeb43de24',
...
INSERT INTO lessons (
  ...
  '630364ec-82d5-5571-b6e9-f749b20c27db', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b57c82c5-7aa3-5794-aaff-0eabce484433',
  '6f7fbf19-ad41-5f93-a920-119992f27f28',
...
INSERT INTO lessons (
  ...
  '93672dfe-15f9-58f1-a27f-80d77c825b9f', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b57c82c5-7aa3-5794-aaff-0eabce484433',
  '6f7fbf19-ad41-5f93-a920-119992f27f28',
...
INSERT INTO lessons (
  ...
  '19f0272a-fa30-5370-af35-454bada8c217', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b57c82c5-7aa3-5794-aaff-0eabce484433',
  '6f7fbf19-ad41-5f93-a920-119992f27f28',
...
INSERT INTO lessons (
  ...
  'c59a4e62-d94a-5050-9938-e5178c6d716c', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b57c82c5-7aa3-5794-aaff-0eabce484433',
  '6f7fbf19-ad41-5f93-a920-119992f27f28',
...
INSERT INTO lessons (
  ...
  'd5bcb7c6-368e-50b4-baf1-ef96c5420113', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b57c82c5-7aa3-5794-aaff-0eabce484433',
  '6f7fbf19-ad41-5f93-a920-119992f27f28',
  NULL, NULL, 'Evaluation',
  2, 18, 18,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'd2840ec8-8583-5af7-b3d2-07ed87f5dd6a', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b57c82c5-7aa3-5794-aaff-0eabce484433',
  '6f7fbf19-ad41-5f93-a920-119992f27f28',
  NULL, NULL, 'Remediation',
  2, 18, 18,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'a4688826-bb4e-5d1f-ac29-41e6206b23bd', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '8315ac79-ae54-5a89-973a-082fe5028c9f',
...
INSERT INTO lessons (
  ...
  '590dce8b-1552-574d-a4a7-cc479f73c960', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '8315ac79-ae54-5a89-973a-082fe5028c9f',
...
INSERT INTO lessons (
  ...
  '70c956b3-c5a3-5a67-8b1b-ae12b5256c90', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  'e153dab1-e418-5c6a-bedf-0a651b771d4f', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  'c2444e06-9add-542f-bd79-0fd1f4d5b5e2', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  '61c99696-8ddb-5067-96d2-f3c014fc51c3', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  'b01237d2-20fd-5f85-9ee2-ea7c8b029fd6', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  'be253956-d1aa-5fbc-b205-679b85a45330', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  'da72e03c-88ef-5f77-af9d-6f105e6cf498', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  '2bcbe4e5-6aa3-5cba-99fa-eb737feb0d2e', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '063973b1-6361-5576-ba1d-22d274b43c15',
...
INSERT INTO lessons (
  ...
  '00e5c59a-5086-50c1-b5fa-8dd6d51faa4e', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '91928cc7-d9bb-57a0-a8bd-2a8c3974c75e',
...
INSERT INTO lessons (
  ...
  '1688847f-fa23-571d-b60b-70c2100d5758', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '91928cc7-d9bb-57a0-a8bd-2a8c3974c75e',
...
INSERT INTO lessons (
  ...
  'eb1a4c65-d9d9-5da5-9b5b-d3d483a9124d', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '91928cc7-d9bb-57a0-a8bd-2a8c3974c75e',
...
INSERT INTO lessons (
  ...
  '37c64ca9-3e0e-5da0-b81f-a9f954a92dbd', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '91928cc7-d9bb-57a0-a8bd-2a8c3974c75e',
  NULL, NULL, 'Evaluation',
  2, 23, 23,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'f757004d-10bf-557b-83aa-af2c4d7a47e8', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '91928cc7-d9bb-57a0-a8bd-2a8c3974c75e',
  NULL, NULL, 'Remediation',
  2, 23, 23,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'd6ae7020-728a-5845-a567-583db8f2fcc6', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  'e057c48c-6e4d-500f-b789-31f326bf4fbe',
...
INSERT INTO lessons (
  ...
  'ea0790eb-c2f3-5ce2-982d-2c01dabcf251', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  'e057c48c-6e4d-500f-b789-31f326bf4fbe',
...
INSERT INTO lessons (
  ...
  '766cc2bf-8da1-52e9-b074-8769f5c3e538', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  'e057c48c-6e4d-500f-b789-31f326bf4fbe',
...
INSERT INTO lessons (
  ...
  '1060e4b2-c82b-571d-88bc-d491e6a9a714', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  '2318c65c-9a89-5d36-bbec-37a0073f80aa',
...
INSERT INTO lessons (
  ...
  '07a421b5-832a-51f5-a401-9f37f6b35d76', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  '2318c65c-9a89-5d36-bbec-37a0073f80aa',
...
INSERT INTO lessons (
  ...
  'c5458ba0-7f95-5f84-9cfa-2bb3dc6b0811', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  '2318c65c-9a89-5d36-bbec-37a0073f80aa',
...
INSERT INTO lessons (
  ...
  'fe9eb0b8-5a96-5384-a3bc-c5adf7fc9d25', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '7d9101e7-22d4-5580-a0d0-fd5a67a96351',
...
INSERT INTO lessons (
  ...
  '2e5f4255-f909-5536-abc2-7a9875e6f10c', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '7d9101e7-22d4-5580-a0d0-fd5a67a96351',
...
INSERT INTO lessons (
  ...
  'f3a9c8b8-bb41-5993-9669-0d22d0fc1a17', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '7d9101e7-22d4-5580-a0d0-fd5a67a96351',
...
INSERT INTO lessons (
  ...
  '6b7b2d64-f4ff-58b7-b9b9-169e44bdac58', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '7d9101e7-22d4-5580-a0d0-fd5a67a96351',
...
INSERT INTO lessons (
  ...
  '6b57b1b4-3823-5dd0-9eb8-edf99ece27c5', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '0c7ff2e1-a9f3-54a4-befe-85e0fd3fafc1',
  NULL, NULL, 'Evaluation',
  3, 27, 27,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'c1b5a68b-bab8-5ef5-bc86-ad07f6f2b6f3', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '0c7ff2e1-a9f3-54a4-befe-85e0fd3fafc1',
  NULL, NULL, 'Remediation',
  3, 27, 27,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'afaad3d2-ebb4-536c-8022-186d26238778', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '0c7ff2e1-a9f3-54a4-befe-85e0fd3fafc1',
...
INSERT INTO lessons (
  ...
  '008b2482-5d2b-5613-b0ae-123dace51479', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '0c7ff2e1-a9f3-54a4-befe-85e0fd3fafc1',
...
INSERT INTO lessons (
  ...
  '6341bbb8-3d98-5777-885d-1607556c5756', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'be83a247-8136-5bcb-8b44-00157af86214',
  '0c7ff2e1-a9f3-54a4-befe-85e0fd3fafc1',
...
INSERT INTO lessons (
  ...
  'aa94fd14-e82f-548b-b7d3-c1de496fb1d0', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'ae91ff23-61c6-54d4-8826-f50665eee233',
  '39f52bd2-576e-5d17-bd34-f710b0248ce5',
  74, 74, 'Logic gates',
  3, 28, 28,
  true, false, false,
...
INSERT INTO lessons (
  ...
  '2ca54430-3e4f-5b6c-807e-abef57561679', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'ae91ff23-61c6-54d4-8826-f50665eee233',
  '39f52bd2-576e-5d17-bd34-f710b0248ce5',
...
INSERT INTO lessons (
  ...
  '718e9e08-eefc-5ac0-bfab-816ce8c38144', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'ae91ff23-61c6-54d4-8826-f50665eee233',
  '39f52bd2-576e-5d17-bd34-f710b0248ce5',
...
INSERT INTO lessons (
  ...
  '0cfdbd79-f9cb-5d0d-8980-5e3aa3342e33', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'ae91ff23-61c6-54d4-8826-f50665eee233',
  '39f52bd2-576e-5d17-bd34-f710b0248ce5',
...
INSERT INTO lessons (
  ...
  '457a8078-46bf-54e2-a333-b9f9e202adeb', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '6c84227d-049c-5332-b809-0b38b62530f3',
...
INSERT INTO lessons (
  ...
  '4661f764-80a6-5ee6-87b5-baf7d81f248a', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '6c84227d-049c-5332-b809-0b38b62530f3',
...
INSERT INTO lessons (
  ...
  '86ea5ce5-098b-5b71-b624-12f0c3b56531', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '6c84227d-049c-5332-b809-0b38b62530f3',
...
INSERT INTO lessons (
  ...
  'ea86a980-3484-5aab-a21e-f0e011202b9b', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  'ff4f0be6-8728-52b1-b276-05d8ae6d7533',
...
INSERT INTO lessons (
  ...
  '6eb51bb2-1714-5163-935b-8eacdad7e547', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  'ff4f0be6-8728-52b1-b276-05d8ae6d7533',
...
INSERT INTO lessons (
  ...
  '496b71d3-f204-5edc-8e90-85ebec65b06d', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  'ff4f0be6-8728-52b1-b276-05d8ae6d7533',
...
INSERT INTO lessons (
  ...
  '43f1b5f9-0195-5ec9-958b-efe97e37e2e4', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', '1dfa7753-f563-557f-97a6-69478902daef',
  'ff4f0be6-8728-52b1-b276-05d8ae6d7533',
...
INSERT INTO lessons (
  ...
  '3d03ea7d-13be-593f-977b-add22af9c37d', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '2f2f678d-3028-5a88-b97a-4f0ec3d656d3',
...
INSERT INTO lessons (
  ...
  'e2daf4e9-608e-51c5-882f-708f1230e8e8', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  '2f2f678d-3028-5a88-b97a-4f0ec3d656d3',
...
INSERT INTO lessons (
  ...
  'c4fff1f2-59c0-56ec-832f-017c65402795', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  'd234982c-0c81-5986-9cfb-061e8876a7e6',
...
INSERT INTO lessons (
  ...
  '14dc362a-76fd-5aff-a236-53f561180e52', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'df4137a6-5a80-5b98-b667-dda47cb185c5',
  'd234982c-0c81-5986-9cfb-061e8876a7e6',
...
INSERT INTO lessons (
  ...
  '882f7a8d-dd7b-5c0f-9453-a8f8b1de02fd', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b8bc06cc-9f8a-5904-8f9f-5746140bef4b',
  'de3308d3-d130-5748-a357-767930a51948',
...
INSERT INTO lessons (
  ...
  'fd15c93c-f2ab-5abb-94ae-2692eb5804b7', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b8bc06cc-9f8a-5904-8f9f-5746140bef4b',
  'de3308d3-d130-5748-a357-767930a51948',
...
INSERT INTO lessons (
  ...
  'c83aac51-d0b1-5c6a-bbc7-6eee2114493e', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b8bc06cc-9f8a-5904-8f9f-5746140bef4b',
  'de3308d3-d130-5748-a357-767930a51948',
...
INSERT INTO lessons (
  ...
  '1d8b0d06-bb1b-5a4b-b716-17a637bc8e21', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b8bc06cc-9f8a-5904-8f9f-5746140bef4b',
  'de3308d3-d130-5748-a357-767930a51948',
  NULL, NULL, 'Evaluation',
  3, 34, 34,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'ada76e9f-c688-568f-a4fb-fc91a41e5445', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b8bc06cc-9f8a-5904-8f9f-5746140bef4b',
  'de3308d3-d130-5748-a357-767930a51948',
  NULL, NULL, 'Remediation',
  3, 35, 35,
  true, false, false,
...
INSERT INTO lessons (
  ...
  'f518b94b-edd7-5af7-87f3-c975bb888289', 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b', 'b8bc06cc-9f8a-5904-8f9f-5746140bef4b',
  NULL,
  NULL, NULL, 'Revision',
  3, 35, 36,
  true, false, false,
...
new_u AS (
  SELECT id, key FROM (
    SELECT n.id,
      ...
      FROM lessons n WHERE n.syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND n.deleted_at IS NULL) t
  WHERE c = 1)
...
UPDATE competencies c SET exam_frequency = f.exam_frequency,
  ...
  FROM old_freq f
 WHERE c.syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND c.deleted_at IS NULL
...
SELECT l.id, s.id, 'full'
 ...
 WHERE l.syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND l.deleted_at IS NULL
   AND src.syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND s.deleted_at IS NULL
...
UNION ALL SELECT 'numbered lessons', count(*)::text FROM lessons
 WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND deleted_at IS NULL AND lesson_no_start IS NOT NULL
UNION ALL SELECT 'objectives', count(*)::text FROM objectives o
 JOIN lessons l ON l.id = o.lesson_id WHERE l.syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND l.deleted_at IS NULL
...
UNION ALL SELECT 'rows archived from the old sheet', count(*)::text FROM lessons
 WHERE syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND deleted_at IS NOT NULL
...
UNION ALL SELECT 'notes with no lesson on the new sheet', count(*)::text
 ...
 WHERE src.syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND s.deleted_at IS NULL
...
UNION ALL SELECT 'uploaded files still attached', count(*)::text
 ...
 WHERE l.syllabus_id = 'd280ec19-0e1f-436e-806e-f8c5fcdf9c6b' AND l.deleted_at IS NULL AND r.deleted_at IS NULL;
